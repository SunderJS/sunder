...
export type SplitRoute<S extends string> =
...
export class Router {
    ...
    public get<S extends string>(path: S, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.get(path, handler, opts);
        return this;
    }

    public post<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.post(path, handler, opts);
        return this;
    }

    public head<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.head(path, handler, opts);
        return this;
    }

    public patch<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.patch(path, handler, opts);
        return this;
    }

    public put<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.put(path, handler, opts);
        return this;
    }

    public all<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.all(path, handler, opts);
        return this;
    }

    public delete<S extends string>(path: string, handler: Handler<PathParams<S>>, opts?: RouteOptions) {
        this.internalRouter.delete(path, handler, opts);
        return this;
    }

    public match<S extends string>(method: string, path: S): RouteHandlerMatch<S> | null {
        const match = this.internalRouter.match(method as Method, path) as RouteHandlerMatch<S> | null;
        return match;
    }
